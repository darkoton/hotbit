<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 7.75V13" stroke="#F2A90C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    <path
    ...
    <path d="M12 16.2V16.2999" stroke="#F2A90C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</template>