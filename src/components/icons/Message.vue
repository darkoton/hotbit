<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      stroke="#0B1723" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
    <path
      ...
      stroke="#0B1723" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M13.4955 13.25H13.5045" stroke="#0B1723" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M9.9955 13.25H10.0045" stroke="#0B1723" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M6.4955 13.25H6.5045" stroke="#0B1723" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</template>