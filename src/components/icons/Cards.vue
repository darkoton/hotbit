<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 12.6101H19" stroke="#F2A90C" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
    ...
    <path
      ...
      stroke="#F2A90C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    <path
      ...
      stroke="#F2A90C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M5.25 17.8101H6.96997" stroke="#F2A90C" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
      stroke-linejoin="round" />
    <path d="M9.10986 17.8101H12.5499" stroke="#F2A90C" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
      stroke-linejoin="round" />
  </svg>
</template>